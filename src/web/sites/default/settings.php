 ...
 * @endcode
 */
$settings['hash_salt'] = 'xFH3drmEIvHEdT7QwvrzsV86izmi4_rTgR-zxcx5jy5bfq3y7ZekBsxQyRng4eGVkUPtEzh7uQ';
...
$settings['config_sync_directory'] = '/opt/drupal/config_files';

$allowed_hosts = explode(',', getenv('ALLOWED_HOSTS'));
$settings['trusted_host_patterns'] = $allowed_hosts;